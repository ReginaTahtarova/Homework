...
namespace lab1.Models
{
    public class Data
    {
        public static string filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "App_Data", "Notes");
        ...
        public void CreateImage(string nameNotepad)
        {
            ...
            graphics.DrawString(nameNotepad, font, new SolidBrush(Color.Red), 0, 0);
            graphics.Flush();
